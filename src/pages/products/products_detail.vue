...
const getProduct = (payload) => store.dispatch("products/getProduct", payload);
const updateProducts = (payload) => store.dispatch("products/updateProducts", payload);
...
getCategories().then(dataCategories=>{
  ...
  getProduct(id.value).then((_data)=>{
    data.value = _data;
    images.value = _data.images.split(",")
    available.value = _data.available === "1"
    best_seller.value = _data.best_seller === "1"
...
const updateData = async () => {
  ...
  let keys = ['id', 'name', 'price', 'brand', 'category',
                      ...
                      >
                        ...
                        <div v-else>
                          <div class="dropzone" v-bind="getRootProps()">
                            ...
                            >
                              <input v-bind="getInputProps()" name="image_principal"  />
                    ...
                    <VRow no-gutters>
                      ...
                      >
                        ...
                        <div class="gallery"  v-else>
                          ...
                          <div >
                            <div class="dropzone mt-10" v-bind="getRootProps()">
                              <div
                                class="border"
                                :class="[
                                isDragActive ? 'isDragActive' : '' ,
